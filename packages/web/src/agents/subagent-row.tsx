 ...
 *
 * **Where the delegated turn runs is not asked here.** It runs where this agent
 * runs, unless the target's own settings pin it somewhere. That is a property of
 * the target rather than of this relationship: an agent needing its own
 * toolchain needs it from every caller, and asking once per roster lets two
 * rosters disagree about one agent.
 */
